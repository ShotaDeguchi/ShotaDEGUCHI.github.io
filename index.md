...
* [My GitHub](https://github.com/ShotaDeguchi) stores several open-access repositories for deep learning (one can run them with GPU for accelerated training, CPU-based training is also supported). 
