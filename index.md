...
* Visit my [GitHub](https://github.com/ShotaDeguchi) for open-access repositories storing deep learning codes (one can run them with GPU for accelerated training). 
