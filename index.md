...
* Visit my [GitHub](https://github.com/ShotaDeguchi) for open-access repositories storing deep learning codes (implements [TensorFlow](https://www.tensorflow.org/) and [PyTorch](https://pytorch.org/)). 
